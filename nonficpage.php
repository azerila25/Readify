...
<html>
    <head>
        ...
        <title>Non-Fiction Collections</title>
    ...
    <body>
        <section class="main">
            ...
            <section class="hero" id="home">
                ...
                <p class="details">
                    'Seorang pembaca hidup seribu kehidupan sebelum dia mati. Orang yang tidak membaca hanya hidup satu.'
                <p class="details">
                    - George R.R. Martin
                </p>
        ...
        <section class="product" id="product">
            ...
            <h1 class="heading">Non-Fiction<span>Collection</span></h1>
