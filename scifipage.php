...
$result = mysqli_query($conn, "SELECT * FROM data_buku_scifi");
?>
<DOCTYPE html>
<html>
    <head>
        ...
        <title>Science Fiction Collections</title>
    ...
    <body>
        <section class="main">
            ...
            <section class="hero" id="home">
                ...
                <p class="details">
                    'Buku adalah senjata yang paling kuat dalam pertempuran melawan intoleransi dan ketidaktahuan.'
                <p class="details">
                    - Lyndon B. Johnson
                </p>
        ...
        <section class="product" id="product">
            ...
            <h1 class="heading">Sci-Fi<span>Collection</span></h1>
