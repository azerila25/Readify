...
$result = mysqli_query($conn, "SELECT * FROM data_buku_inter");
?>
<DOCTYPE html>
<html>
    <head>
        ...
        <title>International Collections</title>
    ...
    <body>
        <section class="main">
            ...
            <section class="hero" id="home">
                ...
                <p class="details">
                    'Buku adalah jendela dunia, dan membacanya adalah cara terbaik untuk memahami dan menghargai keberagaman yang ada di dunia ini.'
                <p class="details">
                    - Barack Obama
                </p>
        ...
        <section class="product" id="product">
            ...
            <h1 class="heading">International<span>Collection</span></h1>
